...
namespace Azavea.Open.DAO.Odp.Tests
{
    ...
    public class OdpSdeStTests
    {
        ...
        public PointClass MakePoint(int x, int y)
        {
            ...
            retVal.Int = x + y;
            retVal.Double = x * y;
            retVal.Shape = new Point(x, y) { SRID = Srid };
            return retVal;
        }
        /// <exclude/>
        public LineClass MakeLine(int x, int y)
        {
            ...
            retVal.Shape = new LineString(coords) { SRID = Srid };
            return retVal;
        }
        /// <exclude/>
        public PolyClass MakePoly(int x, int y)
        {
            ...
            retVal.Shape = new Polygon(new LinearRing(coords)) { SRID = Srid };
            return retVal;
        }
    }
